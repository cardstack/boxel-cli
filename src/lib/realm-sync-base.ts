...
export abstract class RealmSyncBase {
  ...
  protected async getLocalFileListWithMtimes(dir = ''): Promise<Map<string, { path: string; mtime: number }>> {
  ...
  protected async downloadFile(relativePath: string, localPath: string): Promise<void> {
